...
export default function Chat() {
    ...
    return (
        <>
            <div
                className={`min-w-screen overflow-hidden h-screen bg-gradient-to-b from-[#1E1E1E] to-[#6618E7] flex`}
            >
                <div
                    className={`w-1/5 bg-black text-white min-h-[80%] items-center flex flex-col my-5 ml-5 rounded-2xl`}
                >
                ...
                <div className="w-4/5 min-h-[80%] items-center flex flex-col m-5 relative rounded-2xl text-white">
                    <div
                        className={`text-white w-full h-5/6 flex flex-col p-4 ml-[300px] gap-2`}
                    >
                        <ScrollArea
                            className={`gap-2 flex flex-col font-bold ${chatMessages.length == 0 ? "" : "bg-black"} p-8 rounded-3xl w-[70%]`}
                        >
                            {chatMessages.map((message: any, index: any) => {
                                if (index % 2 == 0)
                                    return (
                                        <div className="w-[70%] h-[12%] rounded-xl flex gap-5 p-3 items-center">
                                    ...
                                    return (
                                        <div className="w-[70%] h-[12%] rounded-xl flex gap-5 p-3 items-center">
                                            <p className="text-white ml-10 mt-[-10px] break-words">
                                                {message[2]}
                                            </p>
                                        </div>
                                    );
                    ...
                    <form
                        ...
                        className={`bg-white text-black w-[70%] h-[12%] rounded-[36px] flex gap-5 p-6 items-center`}
                    >
                        <Textarea
